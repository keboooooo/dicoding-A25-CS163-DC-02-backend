...
// Optional caching for quiz generation
// Enable with GENERATION_CACHE_ENABLED=true in .env
export const GENERATION_CACHE_ENABLED =
  String(process.env.GENERATION_CACHE_ENABLED || 'false').toLowerCase() ===
  'true';
